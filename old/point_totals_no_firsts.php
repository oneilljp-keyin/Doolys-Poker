...
<?php
 ...
 echo "<h1>2nd-10th Place Finishes Only</h1>";
...
// }
 ...
 while ($k < $points_num) {
   ...
   if ($id == 219 && $done != 1) {$seat = 0; $bonus_points -= 5; $done = 1;}
   ...
   if ((($id_check != $id) || ($k + 1 == $points_num)) &&  $total_finishes != 0) {
     ...
     $total_games = 0;        $bonus_points = 0;     $total_points = 0;      $seat = 0;    $multiplier = 1;    $points = 0;   $total_finishes = 0;
   }
   $k++;
   $id_check = $id;
   $multiplier = 1;
