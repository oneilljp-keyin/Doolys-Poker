...
// }
 ...
 if ($version != '330/4.5.0.12') {
   ...
   echo "    <td style=\"width: 60px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Location</b></td>\n";
   echo "    <td style=\"width: 50px; border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Type</b></td>\n";
   if ($show == "yes") {
     echo "    <td style=\"width: 25px; border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Fund</b></td>\n";
     echo "    <td style=\"width: 50px; border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>TD</b></td>\n";
     echo "    <td style=\"width: 40px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Players</b></td>\n";
     echo "    <td style=\"width: 40px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Payout</b></td>\n";
     echo "    <td style=\"width: 40px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Jackpot</b></td>\n";
     echo "    <td style=\"width: 40px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Points</b></td>\n";
     echo "    <td style=\"width: 130px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Winner</b></td>\n";
     echo "    <td style=\"width: 130px;  border-bottom: solid 1px #FFFFFF;\" align=\"center\"><b>Bubble</b></td>\n";
   }
...
// }
 ...
 while ($i < $tournament_num) {
   ...
   $i_td           = mysql_result($tournament_result, $i, "td");
     ...
     if ($i_td1 == "-1") {$games_cancelled++;}
   $i_entered      = mysql_result($tournament_result, $i, "entered");
   $i_payout       = mysql_result($tournament_result, $i, "payout");
...
//     echo "$i_payout - $points - $roundup2 - $left2 - $i_points<br />\n";
   ...
   $i_jackpot      = mysql_result($tournament_result, $i, "jackpot");
   ...
   $bubble_query  = "SELECT player_id, player_name
                     FROM points
   ...
   if ($bubble_num  != 0) {
     $bubble_id     = mysql_result($bubble_result, 0, "player_id");
     $bubble_name   = mysql_result($bubble_result, 0, "player_name");
   }
   
   $count_query  = "SELECT player_id
                    FROM points
                    WHERE date = '$i_date' AND location = '$i_location' AND game_type = '$i_type'";
   $count_result = mysql_query($count_query);
   $count_num    = mysql_numrows($count_result);
...
//   echo "$count_num<br />\n";
   ...
   echo "  <tr"; if ($i_td1 == -1) {echo " style=\"
                   background-color: red;\"";} echo ">\n";
   ...
   if ($date_check == $i_date) {
     ...
     echo "    <td valign=\"top\" style=\"width: 24px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">";
       if ($month_check == $i_month && $day_of_week_num != 0) {echo "&nbsp;";} else {echo "$i_month2";}
     echo " </td>\n";
...
//   if ($i_td1 == -1) {echo "<s>";}   
   ...
   if ($i_location == 1) {echo "Top";} else if ($i_location == 1) {echo "Wat";} else {echo "--";}
   }
//   if ($show == "yes") {echo "</a>";}
...
//   if ($i_td1 == -1) {echo "<s>";}
     echo strtr($i_type, $tourn_types); if ($i_td1 == -1) {echo "</s>";} echo "</td>\n";
   if ($show == "yes") {
     echo "    <td valign=\"top\" align=\"center\" style=\"width: 25px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($i_charity == 1) {echo "YES";} else {echo "&nbsp;";} echo "</td>\n";
     echo "    <td valign=\"top\" align=\"center\" style=\"width: 50px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($i_td1 == "0") {echo "--";} else {echo strtr($i_td1, $td_names);} if ($i_td2 == "0") {} else {echo ","; echo strtr($i_td2, $td_names);} echo "</td>\n";

     echo "    <td valign=\"top\" align=\"center\" style=\"width: 40px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($count_num == "0") {echo "--";} else {if($winner_id == "2886") {echo $count_num-1;} else {echo $count_num;}} echo "</td>\n";
     echo "    <td valign=\"top\" align=\"right\" style=\"width: 40px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($i_payout == "0") {echo "--";} else {echo floor($i_payout);} echo "&nbsp;&nbsp;</td>\n";
     echo "    <td valign=\"top\" align=\"right\" style=\"width: 40px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($i_jackpot == "0") {echo "--";} else {echo floor($i_jackpot);} echo "&nbsp;&nbsp;</td>\n";
//     list($integer, $decimal) = split(".", $i_points); echo "$integer.$decimal";
     echo "    <td valign=\"top\" align=\"right\" style=\"width: 40px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if ($i_payout == "0") {echo "--";} else {echo "$i_points";}
       list($integer, $decimal) = explode('.', $i_points); 
//       echo "$integer - $decimal";
       if ($i_type == 8 || $i_type == -1 || $i_td1 == -1){} else { 
         if ($decimal == 0) {echo ".00";} else if ($decimal == 5) {echo "0";}
       }   
     echo "&nbsp;&nbsp;</td>\n";
     echo "    <td valign=\"top\" align=\"center\" style=\"width: 130px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if($winner_id == "2886") {echo "<b><i>--------";} if ($winner_id == "0") {echo "--";} else {echo "$winner_name";} if($winner_id == "2886") {echo "--------</i></b>";} echo "</td>\n";
     echo "    <td valign=\"top\" align=\"center\" style=\"width: 130px;"; if ($day_of_week_num == 0 && $dow_check == 6) {echo " border-top: solid 2px #404040;";} echo "\">"; if($bubble_id == "2886") {echo "<b><i>--------";} if ($bubble_id == "0") {echo "--";} else {echo "$bubble_name";} if($bubble_id == "2886") {echo "--------</i></b>";} echo "</td>\n";
   }
 ...
 if ($show == "yes") {
   ...
   echo "    <td style=\"border-top: solid 2px #404040; font-size: 18px\" colspan=\"14\" align=\"center\">Approx. Total Players: $total_players</td>\n";
   echo "  <tr>\n";
   echo "  <tr style=\"border-top: solid 2px #404040;\">\n";
   echo "    <td style=\"border-top: solid 2px #404040; font-size: 18px\" colspan=\"14\" align=\"center\">Approx. Jackpot Total: $ "; echo number_format($jackpot_total * 0.85, 0, '.', ','); echo "</td>\n";
   echo "  <tr>\n";
   echo "  </tr>\n";
   echo "    <td style=\"border-top: solid 2px #404040; font-size: 15px\" colspan=\"14\" align=\"center\">Estimated Jackpot Total: $ "; echo number_format(round(((($jackpot_total * 0.85)/($i-$games_cancelled)) * (14*7-$games_cancelled)), 2), 0, '.', ','); echo "</td>\n";
   echo "  </tr>\n";
 }
...
/* if ($show == "yes") {
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.29;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.185;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.12;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.10;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.08;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.065;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.055;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.045;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.035;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
 ...
 echo "    <td>$&nbsp;</td><td align=\"right\">";
     $place_payout = ($jackpot_total + 3000) * 0.025;
     $roundup = ceil($place_payout);
     $left = $roundup % 5;
     if ($left >= 2.5) {
       $payout = $roundup - $left + 5;
